...
var DEFAULTS = /** @type {const} */ ({
    ...
    presets: [
        ...
        },
        {
            ...
            "customCSS": "",
            "cssVariables": {
                "tab-navigation-background-color": "#00000053",
                "tab-navigation-text-color": "var(--text-color)",
                "tab-navigation-icon-size": "32px",
                "background-color": "#0F0F0F",
                "text-color": "#FFFFFF",
                "album-background-strength": "0.3",
                "album-background-saturation": "3",
                "album-background-blur-size": "0.1",
                "icon-default-fill": "rgba(0,0,0,0)",
                "icon-default-stroke": "#C5C5C5",
                "icon-active-fill": "var(--icon-active-stroke)",
                "icon-active-stroke": "#FFB306",
                ...
                "player-cover-corner-radius": "2px",
                ...
                "seek-bar-fill": "var(--icon-default-fill)",
                "seek-bar-progress-fill": "var(--icon-default-stroke)",
                "seek-bar-thumb-color": "var(--icon-default-stroke)",
                "seek-bar-stroke": "var(--icon-default-stroke)",
                "volume-bar-fill": "var(--icon-default-fill)",
                "volume-bar-progress-fill": "var(--icon-default-stroke)",
                "volume-bar-thumb-color": "var(--icon-default-stroke)",
                "volume-bar-stroke": "var(--icon-default-stroke)",
        ...
        },
        {
            ...
            "customCSS": "",
            "cssVariables": {
                "tab-navigation-background-color": "#FFFFFF56",
                "tab-navigation-text-color": "var(--text-color)",
                "tab-navigation-icon-size": "32px",
                ...
                "player-main-icons-fill": "var(--icon-default-fill)",
                "player-small-icon-size": "18px",
                "player-minor-icons-stroke": "#292929",
                "player-minor-icons-fill": "var(--icon-default-fill)",
                "seek-bar-fill": "var(--icon-default-fill)",
                "seek-bar-progress-fill": "var(--icon-default-stroke)",
                "seek-bar-thumb-color": "var(--icon-default-stroke)",
                ...
                "seek-bar-size": "1",
                "stations-play-background-color": "rgba(0, 0, 0, 0.5)",
                "stations-active-station-background": "#4586CA",
        ...
        },
        {
            ...
            "cssVariables": {
                ...
                "album-background-strength": "0.2",
                "album-background-saturation": "4",
                "album-background-blur-size": "0.15",
                ...
                "player-cover-corner-radius": "1px",
                ...
                "seek-bar-stroke": "var(--icon-default-stroke)",
                "volume-bar-fill": "var(--icon-default-fill)",
                "volume-bar-progress-fill": "#BDC3C9FF",
                "volume-bar-thumb-color": "#BDC3C9FF",
                "volume-bar-stroke": "#BDC3C9FF",
    ...
    localStorage.setItem(
        ...
        JSON.stringify(
            ({
                'old': 'compact',
                'new': 'cozy'
            })[localStorage.getItem('playerType')] ?? 'cozy'
        )
    );
}
